    ...
    <div className='mt-[80px]'>
      <div className='flex w-full bg-soft-ivory font-playFair'>
        <div className='w-full px-10'>
          ...
          <p className='text-1xl my-5 px-5'>
            Orders can be picked up at our designated location. Please ensure
            you have received a confirmation email stating that your order is
            ready for pickup before coming to the location.
          </p>
          <h2 className='font-bold'>Delivery</h2>
          <p className='text-1xl my-5 px-5'>
            When you choose to deliver your order(s), costs will be shown as
            soon as you check out. We only ship orders on Monday, Tuesday, and
