    ...
    <div className='flex w-full bg-soft-ivory font-playFair'>
      <div className='w-full px-10'>
        ...
        <p className='text-1xl my-5 px-5'>
          ...
          accurately described and priced. However, we cannot guarantee that the
          product descriptions, colors, or other content are error-free. If you
          receive a product that is not as described, please contact us.
        </p>
        <h2 className='font-bold'>3. Order Acceptance</h2>
        <p className='text-1xl my-5 px-5'>
          All orders are subject to acceptance by us. We reserve the right to
          refuse or cancel any order for reasons including, but not limited to,
          product availability, errors in the description, or any other issues.
        </p>
        ...
        <p className='text-1xl my-5 px-5'>
          ...
          are not responsible for delays caused by shipping carriers or customs
          clearance.
        </p>
        ...
        <p className='text-1xl my-5 px-5'>
          ...
          may return unworn, unused items within [insert number] days of receipt
          for a full refund or exchange. Please see our Returns Policy for more
          details.
        </p>
        ...
        <p className='text-1xl my-5 px-5'>
          ...
          is the property of Greens and Prints Store and is protected by
          copyright and trademark laws. You may not use any of our content
          without written permission.
        </p>
        <h2 className='font-bold'>9. Limitation of Liability</h2>

        <p className='text-1xl my-5 px-5'>
          Greens and Prints Store is not liable for any indirect, incidental, or
          consequential damages arising from the use of our products or website.
          Your sole remedy for dissatisfaction with our products is to return
          them in accordance with our Returns Policy.
        </p>
        ...
        <p className='text-1xl my-5 px-5'>
          ...
          laws of New Zealand. Any disputes arising from these terms shall be
          resolved in the appropriate courts of New Zealand.
        </p>
        ...
        <p className='text-1xl m-4 px-10'>
          ...
          Address]. Please ensure you have received a confirmation email stating
          that your order is ready for pickup before coming to the location.
        </p>
        ...
        <p className='text-1xl m-4 px-10'>
          ...
          confirmation (digital or printed) at the time of pickup. This helps us
          ensure that the correct order is handed to the right person.
        </p>
        ...
        <p className='text-1xl m-4 px-10'>
          ...
          pickup. Please wait for this notification before coming to the pickup
          location.
        </p>
