    ...
    <div className='flex w-full bg-soft-ivory font-playFair'>
      <div className='w-full px-10'>
        ...
        <p className='text-1xl my-5 px-5'>
          ...
          files stored on your device that help us recognize you on future
          visits. You can choose to accept or decline cookies through your
          browser settings.
        </p>
        ...
        <p className='text-1xl my-5 px-5'>
          ...
          delivering your order (e.g., shipping providers, payment processors)
        ...
        <p className='text-1xl my-5 px-5'>
          ...
          use of our site after changes are made constitutes your acceptance of
          the new policy.
        </p>
